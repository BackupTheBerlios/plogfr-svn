<?php
	...
	class kses
	{
		...
		//
		// whether we're only using this class to convert to xhtml or
		// also to filter some markup
		//
		var $xhtmlConverterOnly;
		var $aggresiveMode;
         ...
         * xhtml instead of for filtering out markup. When using this mode, the "addHTML" method
         * @param aggressiveMode When the xhtml mode is enabled, it will try to be more aggressive as to
         * what to convert... but bear in mind that it might make more mistakes!!
         * does not do anything
         */
		function kses( $xhtmlConverterOnly = false, $aggressiveMode = false )
		{
		  $this->xhtmlConverterOnly = $xhtmlConverterOnly;
