...
$messages['blog_template_package_help']  = '您可以用這個表單，上傳一個新的模版安裝包，該模版將只有你的網誌能夠使用。如果您沒有辦法用瀏覽器上傳，請手動上傳該模版並將它放置於你的網誌模板資料夾<b>%s</b>下,然後按下 "<b>掃瞄模版</b>" 按紐。 pLog 會掃瞄該資料夾並自動新增所找到的新模版。';
$messages['scan_templates'] = '掃瞄模版';
...
$messages['scan_locales'] = '掃瞄語系檔';
$messages['add_locale_help'] = '您可以用這個表單，上傳一個新的語系檔。如果您沒有辦法用瀏覽器上傳，請手動上傳該檔案並將它放置於 <b>./locales/</b>下,然後按下 "<b>掃瞄語系檔</b>" 按紐。 pLog 會掃瞄該資料夾並自動新增所找到的語系檔。 ';

// site templates
$messages['error_template_is_default'] = '您不可以刪除「%s」模版，因為這是新網誌目前的預設模版。';

// add template
$messages['global_template_package_help'] = '您可以用這個表單，上傳一個新的模版安裝包，該模版將提供給網站上所有網誌使用。如果您沒有辦法用瀏覽器上傳，請手動上傳該模版並將它放置於你的網誌模板資料夾<b>%s</b>下,然後按下 "<b>掃瞄模版</b>" 按紐。 pLog 會掃瞄該資料夾並自動新增所找到的新模版。';
